<header>
    ...
    <div class="head2">
        ...
        <?php
            ...
            $conexion = new Conn();
            $sql = "select * from invitacion where idreceptor = {$_SESSION['idusuario']} AND estado=1";
            $consulta = $conexion->prepare($sql);
            $consulta->execute();
            $count = $consulta->rowCount();
        ?>
            <a href="invitaciones.php"><div id="campana" class="campana">
                <img src="../img/notificaciones.svg" width="50px" height="50px">
                <br>
                <p class="texto"><?php echo $count ?><p>
            </div></a>
