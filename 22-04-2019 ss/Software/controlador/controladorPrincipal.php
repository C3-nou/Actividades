...
$ciclos = new Ciclos();
	...
	if(isset($_POST['aceptarInvitacion'])){
		...
		$rol = $_POST['rol'];
		$acciones->InsertSm($_SESSION['idusuario'], $idproyecto, $rol);

		header('Location: index2.php');
	}

	if(isset($_POST['declinarInvitacion'])){
		$idproyecto = $_POST['idproyecto'];
		$rol = $_POST['rol'];
