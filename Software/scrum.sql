...
17	48	esto es un hola    	2019-02-28	\N	hola	2019-03-07	2	\N
...
COPY public.tarea (id_sprint, nombre, descripcion, valor, estado, id, delete) FROM stdin;
18	entrevista	hacer una entrevista	12	1	1	2019-03-02
18	evento	hacer un evento	10	1	5	2019-03-02
18	entrevista	hacer una entrevista	12	1	2	2019-03-02
18	entrevista	hacer una entrevista	12	1	3	2019-03-02
18	entrevista	hacer una entrevista	12	1	4	2019-03-02
18	prueba	hago una prueba	10	1	6	2019-03-02
18	dato	hago un dato	15	1	7	2019-03-02
18	ejej	ejejejj	20	1	8	2019-03-02
18	daniel	hacer tarea	20	1	10	2019-03-04
20	aaaaaaaa	aaaaaaaaaaa	12	1	11	2019-03-04
20	juio	revisar tarea	15	1	12	\N
18	prueba	esto es una prueba	17	1	9	\N
21	pandita	este es mi pandita	15	2	14	\N
21	pablito	este es escobar	25	2	13	\N
\.
...
SELECT pg_catalog.setval('public.miembro_idmiembro_seq', 59, true);
...
SELECT pg_catalog.setval('public.proyecto_idproyecto_seq', 53, true);
...
SELECT pg_catalog.setval('public.proyectotmp_id_seq', 22, true);
...
SELECT pg_catalog.setval('public.tmp_id_seq', 126, true);
